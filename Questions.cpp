//	Write a C++ program to calculate the given series where the number of terms “N” will be user input.
 //The series is 1+2+3+4+5+…….+N. The series calculation will be done in calculation() method and the
  //method should be defined within class definition.
//   #include<iostream>
//   using namespace std;
//   class sum
//   {
